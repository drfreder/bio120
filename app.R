...
uiMods <- navbarPage("MODELS", id = "inTabset",
                     ...
                     tabPanel(value = "panel2",
                              ...
                              fluidRow(column(12,
                                              ...
                                              tags$p("Two main factors influence colonization and extinction rates:", strong("distance from the mainland"), "and", strong("island size."), "More distant islands are harder to reach than closer islands. As a result, colonization rate decreases with increasing distance from the mainland. Larger islands have more resources than smaller islands, and thus support more species. Therefore, extinction rate decreases with increasing island size."),
